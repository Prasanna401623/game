label school_scene:
    # Show the school background
    scene school_background with fade

    # Background description
    "The school stands tall and quiet under the bright morning sun. Its clean, modern design seems to welcome all who arrive."
    "Neatly trimmed bushes line the entrance, and a gentle breeze rustles the leaves of a few tall trees nearby."
